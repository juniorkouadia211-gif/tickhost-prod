...
// --- SEED EVENTS ---
const seedEvents = () => {
  // Ne plus créer d'événements de démonstration automatiquement.
  // Chaque organisateur crée ses propres événements.
  // Les événements de démo existants restent si déjà créés.
};
